...
@section('content')
    <div class="w-full p-5 text-indigo-900">
        ...
        <div class="md:w-5/6 w-full flex pr-8">
            <div class="h-48 h-auto w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('https://ca.slack-edge.com/T4YLEAKFA-U502E7Q9M-e8ea453ebb33-512');" title="Ashley's mug">
            </div>
