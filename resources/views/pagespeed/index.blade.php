...
@section('content')
    <div class="text-base md:text-sm bg-gray-200 shadow-inner py-6 md:ml-1 md:mr-1">
        <div class="flex flex-col-reverse md:flex-row md:justify-between">
            <div class="text-indigo-900 md:w-2/5 flex flex-col flex-wrap">
                <h3 class="md:-ml-1 text-lg p-3 pl-5 md:rounded-tl-sm shadow-inner md:rounded-bl-sm md:rounded-tr-lg md:rounded-br-lg bg-indigo-900 text-white">
                ...
                <p class="p-5">Well, first of all, this product is <span class="font-bold">100% completely free</span>. Also, now more than ever, Googles ranking is largely affected by things like page load speed, and making sure your site is both ranked well on Google, and running smoothly for your end users is vital.</p>
                    <h3 class="-ml-1 text-lg p-3 pl-5 md:rounded-tl-sm shadow-inner md:rounded-bl-sm md:rounded-tr-lg md:rounded-br-lg bg-indigo-900 text-white">What updates will I receive?</h3>
                <p class="p-5">
            ...
            <div class="text-indigo-900 pb-8 md:pl-20 md:ml-10">
                ...
                <div class="bg-indigo-900 inner-shadow shadow text-white text-lg md:pr-10 -mr-1 md:rounded-tr-sm md:rounded-br-sm md:rounded-tl-lg md:rounded-bl-lg p-6 pt-8">
                    <pagespeed-form>
