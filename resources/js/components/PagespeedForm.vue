<template>
    <form method="post">
        <div v-show="state==1" class="flex flex-wrap flex-inline justify-center">
            <div class="block w-full text-center text-gray-800 font-display mb-2">What URL would you like us to check?</div>
            <div class="flex w-full md:w-3/4 lg:w-1/3 justify-center">
                ...
                <div class="flex-shrink-0">
                    <input type="submit" value="Check" v-on:click.prevent="submit" v-show="!urlValidating" class="h-10 ml-1 bg-indigo-900 px-3 py-1 font-display text-gray-200 rounded hover:bg-indigo-800"/>
        ...
        <div v-show="state==2" class="flex flex-wrap flex-inline justify-center">
            ...
            <div class="block w-full text-center text-gray-800 font-display mb-2">Now we just need the e-mail you'd like to receive your stats</div>
            <div class="flex w-full md:w-3/4 lg:w-1/3 justify-center">
                ...
                <div class="flex-shrink-0">
                    <input v-show="!saving" type="submit" value="Send" v-on:click.prevent="submit" class="h-10 ml-1 bg-indigo-900 px-3 py-1 font-display text-gray-200 rounded hover:bg-indigo-900"/>
        ...
        <div v-show="state==3">
            <div class=" w-full justify-center">
                ...
                <div class="flex justify-center mt-4">
                    <button v-on:click.prevent="updates=true; next()" class="ml-1 bg-indigo-900 px-3 py-1 font-display text-gray-200 rounded hover:bg-indigo-800">Oh I missed that, I do want updates!</button>
